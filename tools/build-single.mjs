...
const head = `<title>CircleSong — FretFlow</title>
<style>
${fonts}${css}
</style>`;
...
<meta name="description" content="CircleSong / FretFlow — an interactive, theory-guided guitar DAW and progression sequencer built on the Circle of Fifths.">
